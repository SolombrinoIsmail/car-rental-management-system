...
export const VALIDATION_MESSAGES = {
  "de-CH": {
    ...
    passwordTooWeak: "Das Passwort muss mindestens 8 Zeichen lang sein und Gross-/Kleinbuchstaben, Zahlen und Sonderzeichen enthalten",
  ...
  "it-CH": {
    ...
    passwordTooWeak: "La password deve contenere almeno 8 caratteri con maiuscole, minuscole, numeri e caratteri speciali",
