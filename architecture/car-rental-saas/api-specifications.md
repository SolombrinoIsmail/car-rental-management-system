...
The Car Rental SaaS API follows RESTful principles combined with GraphQL for complex queries and
real-time subscriptions. The API is built on Next.js 14 with TypeScript and integrates with Supabase
