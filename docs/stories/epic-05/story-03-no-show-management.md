...
1. **AC-01:** System automatically identifies no-shows after configurable grace period (default 2
   hours)
...
**Purpose:** Retrieve reservations at risk of no-show **Response:**
...
**Purpose:** Process automatic or manual no-show **Request Body:**
...
**Purpose:** Convert no-show to rental for late arrivals **Request Body:**
...
**Purpose:** Retrieve customer's no-show pattern **Response:**
...
**Purpose:** Process multiple no-shows automatically **Internal endpoint for scheduled jobs**
