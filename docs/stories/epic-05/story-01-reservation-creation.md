...
2. **AC-02:** System validates that pickup date is before return date with minimum 1-day rental period
...
5. **AC-05:** System calculates estimated total price including base rate, taxes, and optional extras
